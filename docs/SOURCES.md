...
All version and compatibility decisions were checked on 2026-08-31.

- [BEHAVIOR-1K v3.7.2 release](https://github.com/StanfordVL/BEHAVIOR-1K/releases/tag/v3.7.2)
- [BEHAVIOR-1K v3.7.2 setup script](https://raw.githubusercontent.com/StanfordVL/BEHAVIOR-1K/v3.7.2/setup.sh)
- [Bundled R1Pro BEHAVIOR configuration at v3.7.2](https://raw.githubusercontent.com/StanfordVL/BEHAVIOR-1K/v3.7.2/OmniGibson/omnigibson/configs/r1pro_behavior.yaml)
- [Current BEHAVIOR installation guide](https://behavior.stanford.edu/getting_started/installation.html)
